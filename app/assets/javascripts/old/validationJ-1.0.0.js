var VJ = (function(jQuery){
	...
	var opts = {
		...
		message : {
			required : {
				error_msg_format : "Cannot be blank."
			},
			maxlength : {
				error_msg_format : "Must be less than ${1} words."
			},
			minlength : {		
			...
			max : {
				error_msg_format : "Must be less than ${1}"
			},
			min : {	
				error_msg_format : "Must be higher than ${1}"
			},
			range : {
				error_msg_format : "Must be between ${1} and ${2}."
			},
			email : {
			...
			numeric : {
				error_msg_format : "Not a number."
			},
			alpha : {
				error_msg_format : "this is not alphabet"
			},
			alphaNumeric : {
				error_msg_format : "Must be an alphanumeric."
			},
			equal : {
				error_msg_format : "Inputs don't match."
			},
			ajaxv : {
				ajax_msg_format : "Connecting to Server..."
			}
		}
	};
